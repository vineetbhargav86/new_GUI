...
angular.module('iguanaApp.controllers').controller('indexController', 
  function($rootScope, $scope, $stateParams, $http, $log, $filter, $timeout, naclAPI, naclCommon, addonManager, isChromeApp, lodash, uxLanguage, go, isCordova, storageService, $state, isMobile) {

...
angular.module('iguanaApp.services').factory('go', function($window, $rootScope, $location, $state, nodeWebkit,$timeout) {
  var root = {};
...
angular.module('iguanaApp.services').service('addonManager', function (lodash) {
  var addons = [];
...
angular.module('iguanaApp.controllers').controller('indexController', function($rootScope, $scope, $log, $filter, $timeout,naclAPI,naclCommon,addonManager,isChromeApp, lodash, go, isCordova, storageService, $state, isMobile) {
  var self = this;
  ...
  self.setFocusedWallet = function() {
    ...
    $timeout(function() {
      ...
      self.isComplete = true;
      self.copayerId = "XYZ";
      self.walletName = "Personal Wallet";
       self.canSign = true;
        self.isPrivKeyExternal = "EXT_priv";
      self.isPrivKeyEncrypted = true;
      self.account = {};
/*

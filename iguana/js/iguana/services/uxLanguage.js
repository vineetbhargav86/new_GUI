...
angular.module('iguanaApp.services').factory('uxLanguage', 
  function languageService($log, $rootScope, lodash, gettextCatalog, amMoment) {
  ...
  root.update = function(cb) {
    var userLang = $rootScope.app_config.wallet.settings.defaultLanguage

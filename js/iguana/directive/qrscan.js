...
angular.module('iguanaApp.directives')
    .directive('qrScanner', ['$rootScope', '$timeout', '$modal', 'isCordova', 'isMobile', 
      function($rootScope, $timeout, $modal, isCordova,  isMobile) {
        ...
        var controller = function($scope) {
          ...
          $scope.cordovaOpenScanner = function() {
            ...
            window.plugins.spinnerDialog.show(null, getString('Preparing camera...'), true);
            $timeout(function() {
              if (!isMobile.Windows()) {

...
angular.module('iguanaApp.controllers').controller('indexController', function($rootScope, $scope, $log, $filter, $timeout,addonManager,isChromeApp, lodash, go, isCordova, storageService, $state, isMobile) {
  var self = this;

...
angular.module('iguanaApp.controllers').controller('backupController',
  function($rootScope, $scope, $timeout, $log, $state, $compile, go, lodash, gettext) {

    var self = this;
    //var fc = profileService.focusedClient;
    var customWords = [];
    //his.mnemonicWords = fc.getMnemonic();
    ...
    self.addButton = function(index, word) {
      var btnhtml = '<button class="button radius tiny words mnemonic_word" ng-disabled="backup.disableButtons"' +
        'data-ng-click="backup.removeButton($event)" id="_' + index + word + '" > ' + word + ' </button>';
    ...
    function confirm() {
      ...
      var content = JSON.stringify({backup: true});
